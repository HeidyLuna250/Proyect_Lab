    ...
    try {
      ...
      const mensajeRespuesta = {
        ...
        columnas:
          ...
          (datosExtraidos.length > 0 ? Object.keys(datosExtraidos[0]) : []),
      ...
      setMensajes((prev) => [
        ...prev,
        {
          tipo: "ia",
          explicacion:
            "No entendí bien tu consulta. Por favor, reformúlala de forma clara.",
          error: true,
        },
      ]);
    }
        ...
        <div className="d-flex flex-column h-100">
          <div className="flex-grow-1 overflow-auto mb-3 pe-2">
            ...
            {mensajes.map((msg, index) => (
              <div
                key={index}
                className={`mb-4 ${msg.tipo === "usuario" ? "text-end" : ""}`}
              >
                <div
                ...
                >
                  <strong>
                    {msg.tipo === "usuario" ? "Tú:" : "Asistente IA:"}
                  </strong>
                  <br />
